export const caseStatusEmail = (caseData: any) => {
  return `<!DOCTYPE html
    ...
    <head>
        ...
        <title>welcome set password</title><!--[if (mso 16)]>
        <style type="text/css">
                            ...
                            <tr style="border-collapse:collapse">
                                <td align="center" style="padding:0;Margin:0">
                                    <table class="es-header-body" cellspacing="0" cellpadding="0" align="center" role="none"
                                        ...
                                        <tr style="border-collapse:collapse">
                                            <td align="left"
                                                style="Margin:0;padding-top:25px;padding-right:10px;padding-bottom:10px;padding-left:10px">
                                                                    ...
                                                                    <td align="center"
                                                                        style="padding:0;Margin:0;font-size:0"><a
                                                                            ...
                                                                            style="mso-line-height-rule:exactly;text-decoration:underline;color:#CCCCCC;font-size:12px"><img
                                                                                ...
                                                                                alt="Webinar logo" title="Webinar logo"
                                                                                width="139"
                            ...
                            <tr style="border-collapse:collapse">
                                <td align="center" style="padding:0;Margin:0">
                                    <table class="es-content-body"
                                        ...
                                        <tr style="border-collapse:collapse">
                                            <td align="left"
                                                style="Margin:0;padding-top:5px;padding-right:20px;padding-bottom:5px;padding-left:20px;border-radius:0">
                                                <table width="100%" cellspacing="0" cellpadding="0" role="none"
                                                    style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                                    <tr style="border-collapse:collapse">
                                                        <td valign="top" align="center"
                                                            ...
                                                            <table
                                                                style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;border-bottom:1px solid #efefef"
                                                                width="100%" cellspacing="0" cellpadding="0"
                                                                role="presentation">
                                                                <tr style="border-collapse:collapse">
                                                                    <td class="es-text-8592" align="center"
                                                                        style="padding:0;Margin:0;padding-bottom:10px;padding-top:10px">
                                                                        <h4 align="center"
                                                                            style="Margin:0;font-family:arial, 'helvetica neue', helvetica, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:24px;font-style:normal;font-weight:normal;line-height:29px;color:#000000"
                                                                            class="es-m-txt-c"><strong
                                                                                style="line-height:36px"><span
                                                                                    class="es-text-mobile-size-24"
                                                                                    style="font-size:24px">​</span>Case
                                                                                updated!</strong>&nbsp;</h4>
                                                                    </td>
                                                                </tr>
                                                            </table>
                            ...
                            <tr style="border-collapse:collapse">
                                <td align="center" style="padding:0;Margin:0">
                                    <table class="es-content-body" cellspacing="0" cellpadding="0" align="center"
                                        ...
                                        <tr style="border-collapse:collapse">
                                            <td align="left"
                                                style="Margin:0;padding-right:10px;padding-left:10px;padding-top:10px;padding-bottom:15px">
                                                <table width="100%" cellspacing="0" cellpadding="0" role="none"
                                                    style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                                    <tr style="border-collapse:collapse">
                                                        <td valign="top" align="center"
                                                                ...
                                                                <tr style="border-collapse:collapse">
                                                                    <td align="center"
                                                                        style="padding:0;Margin:0;font-size:0"><img
                                                                            src="https://fikwdbf.stripocdn.email/content/guids/CABINET_5c6d8792e67210e3997776beb2eaab2ba3c166aaa697e7716392b6b9298a93ce/images/vector.png"
                                                                            alt="Webinar logo" title="Webinar logo"
                                                                            class="img-9964" width="139"
                                                    ...
                                                    <tr style="border-collapse:collapse">
                                                        <td valign="top" align="center"
                                                            ...
                                                            <table
                                                                ...
                                                                role="presentation">
                                                                <tr style="border-collapse:collapse">
                                                                    <td class="es-text-8481" align="center"
                                                                        style="padding:0;Margin:0;padding-bottom:10px;padding-top:10px">
                                                                        <h5 align="center"
                                                                            style="Margin:0;font-family:arial, 'helvetica neue', helvetica, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:20px;font-style:normal;font-weight:normal;line-height:30px !important;color:#333333"
                                                                            class=" es-m-txt-c">
                                                                            The status of case <b>#${caseData.caseId}</b> has been updated to
                                                                            <b>"${caseData.status}.</b>
                                                                        </h5>
                                                                    </td>
                                                                </tr>
                            ...
                            <tr style="border-collapse:collapse">
                                <td align="center" style="padding:0;Margin:0">
                                    <table class="es-footer-body"
                                        ...
                                        cellspacing="0" cellpadding="0" bgcolor="#efefef" align="center" role="none">
                                        <tr style="border-collapse:collapse">
                                            <td align="left"
                                                                ...
                                                                <tr style="border-collapse:collapse">
                                                                    <td esdev-links-color="#666666" align="center"
                                                                        ...
                                                                        <p
                                                                            ...
                                                                            Questions? &nbsp;24/7 Support: (<span
                                                                                style="color:#0b5394">+</span><a
                                                                                style="mso-line-height-rule:exactly;text-decoration:underline;color:#383C6E;font-size:12px"
                                                                                target="_blank"
                                                                                href="tel:123456789">123456789</a>) | <a
                                                                                style="mso-line-height-rule:exactly;text-decoration:underline;color:#383C6E;font-size:12px"
                                                                                target="_blank"
                                                                                href="https://nextdentallab.com">nextdentallab.com</a>
                                                                        </p>
                                                                    </td>
                                                                </tr>
                                                            </table>
